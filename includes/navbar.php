...
function getProfileImageUrl()
{
    ...
    $initial = substr($_SESSION['user_name'] ?? 'U', 0, 1);
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link px-3 fw-medium text-dark" href="index.php#home">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3 fw-medium text-dark" href="index.php#learning-path">Learning Path</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3 fw-medium text-dark" href="blogs.php">Blogs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link px-3 fw-medium text-dark" href="index.php#contact">Contact</a>
                </li>
            </ul>
            ...
            <div class="d-flex align-items-center gap-2">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <?php if ($_SESSION['user_role'] === 'student'): ?>
                        <a href="dashboard.php" class="btn btn-link text-decoration-none fw-bold text-dark px-4">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="dashboard.php" class="btn btn-link text-decoration-none fw-bold text-dark px-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item text-danger" href="backend/auth/logout.php">Logout</a></li>
                        </ul>
                    </div>
                <?php else: ?>
